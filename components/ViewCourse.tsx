...
const ViewCourse = ({ course, modules, enrolled }: ViewCourseProps) => {
  ...
  return (
    <div className="grid grid-cols-12  gap-4">
      ...
      <div className="flex justify-center items-center col-span-12 mb-10">
        {selectedModule && (
          <div className="w-full flex flex-col gap-3">
            ...
            <h1 className="text-3xl">{selectedModule.title}</h1>
            <h1 className="text-lg">{selectedModule.description}</h1>
          </div>
        )}
      </div>
